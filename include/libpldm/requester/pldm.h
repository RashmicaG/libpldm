 ...
 *
 * @param[in] transport - MCTP transport
 ...
 */
pldm_requester_rc_t pldm_send_recv(mctp_eid_t eid, int mctp_fd __attribute__((unused)),
 ...
 * @return pldm_requester_rc_t (errno may be set)
 */
pldm_requester_rc_t pldm_send(mctp_eid_t eid, int mctp_fd __attribute__((unused)),
 ...
 */
pldm_requester_rc_t pldm_recv(mctp_eid_t eid, int mctp_fd __attribute__((unused)), uint8_t instance_id,
 ...
 */
pldm_requester_rc_t pldm_recv_any(mctp_eid_t eid, int mctp_fd __attribute__((unused)),
...
/**
 * @brief Connect to transport transport and provide an fd to it. The fd can be
 *        used to pass as input to other APIs below, or can be polled.
 *        s/open/setup?
 *
 * @return fd on success, pldm_requester_rc_t on error (errno may be set)
 */
pldm_requester_rc_t pldm_open_transport(struct pldm *p, struct pldm_transport *transport);

/**
 * @brief Close the transport transport
 *
 * @return fd on success, pldm_requester_rc_t on error (errno may be set)
 */
pldm_requester_rc_t pldm_close_transport(struct pldm *p, struct pldm_transport *transport);
